/*
 * 版权所有(c) 2022 - 2022
 * 项目名称: alisdy -- 文件名称: java_sql.java
 * Date: 2022/6/20 下午2:21
 * Author: yijie
 */
...
public class java_sql {
    ...
    public static void main(String[] args) throws Exception {
        ...
        获取Statement接口对象,依靠connection提供的方法完成:
            ...
            数据更新处理: int executeUpdate(String sql) throws SQLException
            数据查询处理: ResultSet executeQuery(String sql) throws SQLException
         */
