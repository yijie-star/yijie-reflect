package cn.iutils.BeanUtils;


import cn.iutils.StringUtils.StringUtils;
            ...
            for (int i = 0; i < results.length; i++) {//循环设置属性内容
                ...
                try {
                    if (attval[0].contains(".")){//多级配置
                        ...
                        Object convertAttributeValueval = cn.iutils.BeanUtils.BeanUtils.convertAttributeValue(field.getType().getName(),attval[1]);
